...
5. Access GitLab in your browser:
    ...
    - Server: [https://gitabl.example.com](https://gitabl.example.com)
...
7. Log in to GitLab:
    ...
    - URL: [http://localhost:8013](http://localhost:8013) (local) or [https://gitabl.example.com](https://gitabl.example.com) (server)
    - Username: `root`
